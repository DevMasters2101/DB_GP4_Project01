...
void AGP4_P01_ClimbingCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AGP4_P01_ClimbingCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGP4_P01_ClimbingCharacter::Move);
...
void AGP4_P01_ClimbingCharacter::Move(const FInputActionValue& Value)
{
...
void AGP4_P01_ClimbingCharacter::HandleGroundMovementInput(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGP4_P01_ClimbingCharacter::HandleClimbMovementInput(const FInputActionValue& Value)
{
	// input is a Vector2D
	const FVector2D MovementVector = Value.Get<FVector2D>();
...
void AGP4_P01_ClimbingCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
